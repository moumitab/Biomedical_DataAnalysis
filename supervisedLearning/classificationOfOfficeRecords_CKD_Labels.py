#Divide the office record set in 3 parts train set, test set and validation set
#The office set has 192 predictors - with 139 SNOMED codes and 53 demographic and other features
# We will only include the top 100 features for our model building
# The top features will be selected based on feature selection done using random forest
