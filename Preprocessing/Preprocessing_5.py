...
with open('C:\\Users\\Moumita\\Dropbox\\Research_Phase2\\Hospital_cond.csv','r') as csvinput:
    with open('C:\\Users\\Moumita\\Dropbox\\Research_Phase2\\Hospital_cond_desc.csv', 'w') as csvoutput:
